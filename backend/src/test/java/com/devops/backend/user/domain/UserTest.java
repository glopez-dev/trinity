package com.devops.backend.user.domain;

import com.devops.backend.user.domain.enums.EmployeeRole;
import com.devops.backend.user.domain.enums.UserStatus;
import com.devops.backend.user.domain.events.AccountDeleted;
import com.devops.backend.user.domain.events.EmployeePromoted;
import com.devops.backend.user.domain.events.UserConnected;
import com.devops.backend.user.domain.events.UserEvent;
import com.devops.backend.user.domain.model.Customer;
