...
class ProductEntityTest {
    ...
    void testGetNutrientLevels() {
        // Given
        ProductEntity.NutrientLevels nutrientLevels = ProductEntity.NutrientLevels.builder()
                .fat("High")
                .saturatedFat("Medium")
                .sugars("High")
                .salt("Low")
        ...
        // When
        ProductEntity.NutrientLevels result = product.getNutrientLevels();
    ...
    void testGetNutriments() {
        // Given
        ProductEntity.Nutriments nutriments = ProductEntity.Nutriments.builder()
                .energyKcal100g(42.0)
                .proteins100g(0.0)
        ...
        // When
        ProductEntity.Nutriments result = product.getNutriments();
    ...
    void testGetSelectedImages() {
        // Given
        ProductEntity.SelectedImages selectedImages = ProductEntity.SelectedImages.builder()
                .display(new ProductImageUrlEmbeddable())
                .small(new ProductImageUrlEmbeddable())
                .thumb(new ProductImageUrlEmbeddable())
                .build();
        product.setSelectedImages(selectedImages);

        // When
        ProductEntity.SelectedImages result = product.getSelectedImages();
    ...
    void testGetStock() {
        // Given
        ProductEntity.Stock stock = new ProductEntity.Stock();
        ...
        // When
        ProductEntity.Stock result = product.getStock();
