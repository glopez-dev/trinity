...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void rejectAsUnauthorized(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // Mirrors the ErrorResponse shape used by GlobalExceptionHandler; built by hand
        // because this filter runs before Spring MVC and its message converters.
        response.getWriter().write("""
                {"timestamp":"%s","status":401,"error":"Unauthorized","message":"Invalid or expired JWT","path":"%s"}"""
